...
#     _name = 'hr.appraisaldep'
#     _inherit = ['mail.thread', 'mail.activity.mixin']
#     _description = "Appraisal Goal for departement"
#
...
#     manager_id = fields.Many2one('hr.employee', string="Manager", compute="_compute_manager_id", readonly=False,
